...
StreamBuilder orderProductTile(double width,double height,String prodId,int quantity){
  return StreamBuilder<QuerySnapshot>(
    stream: FirebaseFirestore.instance.collection('products').where('sku',isEqualTo: prodId).snapshots(),
